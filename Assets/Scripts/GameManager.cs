...
public class GameManager : MonoBehaviourPunCallbacks 
{
   ...
   // [SerializeField] string userID;
    ...
    public Color playerOneMessage, playerTwoMessage;
    ...
    void Update()
    {
       // chatclient.Service();
        ...
        if (chatBox.text != "")
        {
            ...
            {
                sendMessageToChat(chatBox.text, Message.MessageType.playerOneMessage);
                chatBox.text = "";

                sendMessageToChat(chatBox.text, Message.MessageType.playerTwoMessage);
                chatBox.text = "";
            }
        }
        else
    ...
    {
        Color color = playerOneMessage;

        switch(messageType)
        {
            case Message.MessageType.playerOneMessage:
                color = playerOneMessage;
                break;

            case Message.MessageType.playerTwoMessage:
                color = playerTwoMessage;
                break;
        }
    ...
    void Start()
    {
         ...
         //chatclient = newChatClient(this);

         //chatclient.Connect(PhotonNewtwork.PhotonServerSettings.AppSettings.AppIdChat, PhotonNetwork.AppVersion, new AuthenticationValues(userID));
